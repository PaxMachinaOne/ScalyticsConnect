      ...
      <MaintenanceSectionHeader title="Model Maintenance">
        {modelDirectories.length > 0 && (
          <button 
            ...
            className="px-4 py-2 bg-red-600 hover:bg-red-700 dark:bg-red-700 dark:hover:bg-red-800 text-white rounded-sm flex items-center disabled:opacity-50 disabled:cursor-not-allowed"
          >
