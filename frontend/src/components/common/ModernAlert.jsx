...
/**
 * A modern, animated alert component with auto-dismiss functionality
 * 
 ...
 * @param {number} props.autoDismiss Time in ms to auto-dismiss (0 to disable)
...
const ModernAlert = ({ 
  ...
  }, [message, autoDismiss, handleDismiss]);
