  ...
  return (
    <div className="px-4 py-5 sm:px-6">
      ...
      {chats.length > 0 && (
        ...
        <Link
          to="/chat"
          className="w-full flex justify-center items-center px-4 py-2 border border-gray-300 dark:border-dark-border shadow-xs text-sm font-medium rounded-md text-gray-700 dark:text-dark-text-primary bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600"
        >
          View All Chats
        </Link>
        </div>
