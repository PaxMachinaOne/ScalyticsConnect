      ...
      return (
        <div className="text-center py-8">
          ...
          <button
            ...
            className="inline-flex justify-center py-2 px-4 border border-transparent shadow-xs text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-hidden focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-gray-800 focus:ring-blue-500"
          >
            Go to Login
          </button>
        </div>
          ...
          <div>
            ...
            <div className="mt-1">
              <input
                ...
                required
                className="appearance-none block w-full px-3 py-2 border border-gray-300 dark:border-dark-border rounded-md shadow-xs placeholder-gray-400 dark:placeholder-dark-text-secondary bg-white dark:bg-gray-700 text-gray-900 dark:text-dark-text-primary focus:outline-hidden focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
