...
class ResearchComptroller:
    ...
    async def recommend_targeted_site_reinvestigation(
        ...
        if not self.settings.DEEP_SEARCH_ENABLE_FOCUSED_SITE_EXPLORATION:
            return None
        ...
        prioritization_result = await llm_reasoner.prioritize_internal_links_for_exploration(
            ...
            top_n=self.settings.DEEP_SEARCH_FOCUSED_SITE_MAX_PAGES_PER_TRIGGER or 3 
        )
        ...
        if selected_urls:
            return models.TargetedSiteExplorationDirective(
                ...
                max_pages_for_this_exploration=self.settings.DEEP_SEARCH_FOCUSED_SITE_MAX_PAGES_PER_TRIGGER or 3,
    ...
    def assess_latency_and_cost(self, state: models.OverallState, current_node_name: str):
        ...
        low_confidence_threshold = self.settings.DEEP_SEARCH_LOW_CONFIDENCE_THRESHOLD_PERCENTAGE 
    ...
    def should_enable_low_confidence_synthesis_mode(self, state: models.OverallState) -> bool:
        ...
        unverified_count = 0
        total_relevant_dps = 0
        low_confidence_threshold_percentage = self.settings.DEEP_SEARCH_LOW_CONFIDENCE_THRESHOLD_PERCENTAGE 
