...
class ResearchController:
    def __init__(self, task_id: str, 
        ...
        self.state = models.ResearchControllerState(
            ...
            max_total_urls_per_task=max_total_urls_override if max_total_urls_override is not None else self.settings.DEEP_SEARCH_MAX_TOTAL_URLS_PER_TASK,
            max_stagnation_limit=self.settings.DEFAULT_STAGNATION_LIMIT,
            current_reasoning_dynamic_temperature=self.settings.DEEP_SEARCH_REASONING_DEFAULT_TEMP,
        )
    ...
    def initialize_control_state(self, 
        ...
        self.state.current_reasoning_dynamic_temperature = self.settings.DEEP_SEARCH_REASONING_DEFAULT_TEMP
