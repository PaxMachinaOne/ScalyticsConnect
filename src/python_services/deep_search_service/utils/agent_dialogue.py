...
CONTROLLER_TASK_START = "**[Research Strategist]** Initializing Deep Search task. I will break down the query and plan the research."
...
DATA_COLLECTOR_PREFIX = "**[Data Collector]**"
LIBRARIAN_PREFIX = "**[Librarian]**"
LINK_EXTRACTOR_PREFIX = "**[Link Extractor]**"
KNOWLEDGE_ARCHITECT_PREFIX = "**[Knowledge Architect]**" 
...
DATA_COLLECTOR_READING_URL = f"{DATA_COLLECTOR_PREFIX} Reading content from: {{url}}."
...
# Natural reasoning messages for Claude/OpenAI-like flow
INITIAL_LLM_REASONING = "{key_aspects}"
SEARCH_REASONING = "Searching for information about {search_topics}."
SEARCH_REASONING_WITH_WHY = "Searching for '{search_topic}' because {why_explanation}."
CONTENT_ANALYSIS_REASONING = "I found {findings_summary} and I'm analyzing them to understand the topic better."
SYNTHESIS_REASONING = "I'm creating a comprehensive synthesis based on my findings about {covered_topics}."
FACT_CHECK_REASONING = "Let me check this one: {claim_topic}."

# Enhanced Librarian messages with natural explanations
...
LIBRARIAN_ANALYSIS_START = "I'm analyzing the retrieved content to understand {research_focus}."
...
LIBRARIAN_ANALYSIS_COMPLETE_HOP = "I found {summary_of_findings}. {gaps_or_next_steps}"
...
SYNTHESIS_START = "**[Editor]** Synthesizing comprehensive report from research findings..."
...
SYNTHESIS_DRAFT_ERROR_FALLBACK = "**[Editor]** Error during draft synthesis. Please try again or contact support."
KNOWLEDGE_ARCHITECT_DRAFTING = f"**[Editor]** Generating initial draft of the report..."
...
DOCUMENT_ANALYST_INGESTION_START = f"{DOCUMENT_ANALYST_PREFIX} Starting detailed analysis of uploaded documents..." 
DOCUMENT_ANALYST_INGESTION_COMPLETE = f"{DOCUMENT_ANALYST_PREFIX} Document analysis completed." 

# System (already has some, can add more if needed)
SYSTEM_PROGRESS_UPDATE = f"{SYSTEM_PREFIX} {{message}}" 
